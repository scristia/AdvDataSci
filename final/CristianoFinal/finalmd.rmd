---
title: "finalrmarkdown"
author: "Stephen Cristiano"
date: "October 19, 2015"
output: html_document
---

Need the following R packages:
```{r, echo=FALSE}
library(rvest)
library(devtools)
library(plyr)
library(dplyr)
```
This is not evaluated, just code for getting some data
...
Analysis. Cleaned up data set comes from a collaboration with the rest of the class, but not all the code has been shared amongst us.
